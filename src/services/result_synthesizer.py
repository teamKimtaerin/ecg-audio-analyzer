...
class SimplifiedResultSynthesizer:
    ...
    def _create_timeline_segment(self,
                                speaker_segment: SpeakerSegment,
                                segment_index: int) -> TimelineSegment:
    ...
    def _create_speakers_dict(self,
    ...
    def _create_performance_stats(self,
                                 ...
                                 synthesis_time: float) -> PerformanceStats:
    ...
    def export_json(self,
        ...
        try:
            ...
            self.logger.info("json_exported",
    ...
    def synthesize_and_export(self,
                            synthesis_input: SynthesisInput,
                            output_path: Path,
                            prettify: bool = True) -> Tuple[CompleteAnalysisResult, Path]:
        """
