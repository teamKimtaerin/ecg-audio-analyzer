...
class FastAcousticAnalyzer:
    ...
    def _extract_volume_features(self, audio: np.ndarray) -> Tuple[float, float, VolumeCategory]:
    ...
    def extract_features(self,
        ...
        try:
            ...
            self.logger.error("feature_extraction_failed",
                            error=str(e),
    ...
    def extract_batch_features(self,
                              audio_path: Path,
                              segments: List[Tuple[float, float, str]]) -> List[AudioFeatures]:
        """
        ...
        with ThreadPoolExecutor(max_workers=min(4, len(segments))) as executor:
            ...
            for future in as_completed(futures):
                ...
                try:
                    ...
                    self.logger.error("batch_segment_failed",
                                    index=idx,
                                    error=str(e))
