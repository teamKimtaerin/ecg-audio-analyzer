...
class TestSpeakerDiarizer:
    ...
    def test_audio_segment_loading(self, speaker_config, sample_audio_file, mock_pyannote):
    ...
    def test_diarize_audio_success(self, speaker_config, sample_audio_file, mock_pyannote):
    ...
    def test_chunk_processing(self, speaker_config, sample_long_audio_file, mock_pyannote):
    ...
    def test_error_handling_during_processing(self, speaker_config, sample_audio_file, mock_pyannote):
