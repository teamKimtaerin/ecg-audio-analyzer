...
from src.utils.duration_validator import (
    DurationValidator,
    DurationProbeResult,
...
class TestDurationValidator:
    ...
    def test_probe_with_ffmpeg_python_success(self, mock_probe, validator):
        ...
        mock_probe.return_value = {"format": {"duration": "142.3"}}
    ...
    def test_probe_video_duration_integration(
        self, mock_stream, mock_container, mock_ffmpeg, mock_ffprobe, validator
    ):
